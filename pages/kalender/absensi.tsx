...
const absensi = () => {
  return (
    <>
      <MetaSeo title="Dashboard" description="Dashboard pengelolaan absensi" />
      <LayoutDashboard>
        <div className="w-full mx-auto bg-white shadow-lg border-4 border-light-blue-400 rounded-3xl py-2 px-5 md:py-3 md:px-6">
          <p>
